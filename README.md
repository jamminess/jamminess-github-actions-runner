...
This project builds and deploys self-hosted Github Runners to the jamminess github organisation. It's deployed to Cloud Platforms, using Helm.
...
#### References
The build process is based on the [browser-testing-github-actions-runner](https://github.com/jamminess/browser-testing-github-actions-runner) project.
